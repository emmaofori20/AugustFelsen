        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArtisanProfileId = table.Column<int>(type: "int", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtisanReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArtisanReviews_ArtisanProfiles_ArtisanProfileId",
                        column: x => x.ArtisanProfileId,
                        principalTable: "ArtisanProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtisanReviews_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedProfessionalId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Projects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Projects_AspNetUsers_AssignedProfessionalId",
                        column: x => x.AssignedProfessionalId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Quotes_SupplierProfiles_SupplierProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierProducts_SupplierProfiles_SupplierProfileId",
                        column: x => x.SupplierProfileId,
                        principalTable: "SupplierProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtisanReviews_ArtisanProfileId",
                table: "ArtisanReviews",
                column: "ArtisanProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtisanReviews_UserId",
                table: "ArtisanReviews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_AssignedProfessionalId",
                table: "Projects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotes_SupplierProfileId",
                table: "Quotes",
                column: "SupplierProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierProducts_SupplierProfileId",
